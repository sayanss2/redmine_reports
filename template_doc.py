...
output_from_parsed_template = xml_body_template.render(xml_project_name = csv_parser.get_ProjectVersion(), xml_count_project = csv_parser.get_cntProjectVersion(), xml_count_issue = '5')
